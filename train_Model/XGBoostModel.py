...
xgb_clf = XGBClassifier(objective='multi:softmax', num_class=3, booster='gbtree', n_jobs=16, random_state=42)
...
# 创建一个GridSearchCV对象
grid_search = GridSearchCV(estimator=xgb_clf, param_grid=param_grid, cv=kfold, n_jobs=16,scoring='accuracy',verbose=10)
# 在训练集上训练模型
